import require$$0, { options, render } from "preact";
var index = "";
var jsxs$1;
var jsx$1;
var r$1 = require$$0, _ = 0;
...
const jsx = jsx$1;
const jsxs = jsxs$1;
var t, u, r, o = 0, i = [], c = options.__b, f = options.__r, e = options.diffed, a = options.__c, v = options.unmount;
function m(t2, r2) {
  options.__h && options.__h(u, t2, o || r2), o = 0;
...
function y(r2, o2) {
  var i2 = m(t++, 3);
  !options.__s && k(i2.__H, o2) && (i2.__ = r2, i2.__H = o2, u.__H.__h.push(i2));
}
function s(n) {
  ...
  i.forEach(function(t2) {
    if (t2.__P)
      try {
        ...
        t2.__H.__h = [], options.__e(u2, t2.__v);
      }
  }), i = [];
}
options.__b = function(n) {
  ...
  e && e(t2);
  var o2 = t2.__c;
  o2 && o2.__H && o2.__H.__h.length && (i.push(o2) !== 1 && r === options.requestAnimationFrame || ((r = options.requestAnimationFrame) || function(n) {
    var t3, u2 = function() {
      clearTimeout(r2), b && cancelAnimationFrame(t3), setTimeout(n);
    }, r2 = setTimeout(u2, 100);
    b && (t3 = requestAnimationFrame(u2));
  })(x)), u = null;
}, options.__c = function(t2, u2) {
  u2.some(function(t3) {
    try {
...
const mountExample = (Element, selector) => {
  render(jsx(Element, {}), document.querySelector(selector));
};
export { ExampleHueShiftHSL, ExampleHueShiftRGB, ExampleRGBHSL, ExampleScroll, mountExample };
